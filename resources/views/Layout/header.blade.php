            ...
            <div class="row">
                ...
                <div class="col-sm-4 offset-md-1 py-4">
                    ...
                    @else
                        ...
                        <ul class="list-unstylead">
                            <li><a href="{{ url('logout') }}"
                                    class="text-white"onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout
                                </a></li>
    ...
    <div class="navbar navbar-dark bg-warning shadow-sm">
        <div class="container">
            <a href="#" class="navbar-brand d-flex align-items-center">
                ...
                <strong style="color: black">FE!N MOVIES</strong>
            </a>
